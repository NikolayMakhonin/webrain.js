...
class ValueState {
  ...
  getRef() {
    ...
    if (refs) {
      const id = (0, _objectUniqueId.getObjectUniqueId)(this.target);
...
class TypeMetaMergerCollection extends _TypeMeta.TypeMetaCollection {
  constructor(proto) {
...
registerMerger(Object, {
  merger: {
    ...
    merge(merge, base, older, newer, set, preferCloneOlder, preferCloneNewer, options) {
      return (0, _mergeMaps.mergeMaps)(_mergeMaps.createMergeMapWrapper, merge, base, older, newer, preferCloneOlder, preferCloneNewer, options);
    }
...
registerMerger(Set, {
  merger: {
    ...
    merge(merge, base, older, newer, set, preferCloneOlder, preferCloneNewer, options) {
      return (0, _mergeMaps.mergeMaps)((target, source) => (0, _mergeSets.createMergeSetWrapper)(target, source, arrayOrIterable => (0, _set.fillSet)(new Set(), arrayOrIterable)), merge, base, older, newer, preferCloneOlder, preferCloneNewer, options);
    }
...
registerMerger(Map, {
  merger: {
    ...
    merge(merge, base, older, newer, set, preferCloneOlder, preferCloneNewer, options) {
      return (0, _mergeMaps.mergeMaps)((target, source) => (0, _mergeMaps.createMergeMapWrapper)(target, source, arrayOrIterable => (0, _set.fillMap)(new Map(), arrayOrIterable)), merge, base, older, newer, preferCloneOlder, preferCloneNewer, options);
    }
