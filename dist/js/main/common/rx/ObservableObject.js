...
exports.ObservableObjectBuilder = exports.ObservableObject = void 0;
...
class ObservableObjectBuilder {
  ...
  propagatePropertyChanged(propertyName, value) {
    ...
    return object.propertyChanged.hasSubscribersObservable.autoConnect(null, () => propertyChanged.subscribe(subscriber));
  }

  writable(name, {value: initValue}) {
    const {
      object
    } = this;
    const {
