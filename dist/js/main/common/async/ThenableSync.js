...
function () {
  ...
  var _proto = ThenableSync.prototype;
  ...
  _proto._resolve = function _resolve(value) {
    var _this = this;
  ...
  _proto._reject = function _reject(error) {
    var _this2 = this;
  ...
  _proto._then = function _then(onfulfilled, onrejected, lastExpression, customResolveValue) {
  ...
  _proto.then = function then(onfulfilled, onrejected, customResolveValue) {
    return this._then(onfulfilled, onrejected, false, customResolveValue === false ? null : customResolveValue || this._customResolveValue);
  };

  _proto.thenLast = function thenLast(onfulfilled, onrejected, customResolveValue) {
