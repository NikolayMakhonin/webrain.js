...
function (_ListChangedObject) {
  (0, _inheritsLoose2.default)(SortedList, _ListChangedObject);
  ...
  function SortedList(_temp) {
    ...
    _this = _ListChangedObject.call(this) || this;
  ...
  _proto._updateAllocatedSize = function _updateAllocatedSize() {
  ...
  _proto._setSize = function _setSize(newSize) {
  ...
  // endregion
  // region Methods
  SortedList._prepareIndex = function _prepareIndex(index, size) {
    if (index < 0) {
      index += size;
    }
  ...
  SortedList._prepareStart = function _prepareStart(start, size) {
    if (start == null) {
      start = 0;
    }
  ...
  SortedList._prepareEnd = function _prepareEnd(end, size) {
    if (end == null) {
      end = size;
    }
  ...
  _proto.removeDuplicates = function removeDuplicates(withoutShift) {
    var _array = this._array;
    var count = 0;
    var i = this._size - 1;
  ...
  _proto.addArray = function addArray(sourceItems, sourceStart, sourceEnd) {
    return this.insertArray(this._size, sourceItems, sourceStart, sourceEnd);
  };

  _proto.addIterable = function addIterable(items, itemsSize) {
    return this.insertIterable(this._size, items, itemsSize);
  };

  _proto._insert = function _insert(index, item) {
    var size = this._size,
        _array = this._array;
    var newSize = size + 1;
  ...
  _proto.insert = function insert(index, item) {
    var _context10;
  ...
  _proto.insertArray = function insertArray(index, sourceItems, sourceStart, sourceEnd) {
    var size = this._size,
        _array = this._array,
        _autoSort = this._autoSort;
  ...
  _proto.insertIterable = function insertIterable(index, items, itemsSize) {
    var size = this._size,
        _array = this._array;
  ...
  _proto.removeAt = function removeAt(index, withoutShift) {
    var size = this._size,
        _array = this._array,
        _autoSort = this._autoSort;
  ...
  _proto.removeRange = function removeRange(start, end, withoutShift) {
    var size = this._size,
        _array = this._array;
  ...
  _proto.remove = function remove(item, withoutShift) {
    var _context11;
  ...
  _proto.removeArray = function removeArray(sourceItems, sourceStart, sourceEnd) {
    var itemsSize = sourceItems.length;
    sourceStart = SortedList._prepareStart(sourceStart, itemsSize);
    sourceEnd = SortedList._prepareEnd(sourceEnd, itemsSize);
    var result = false;
  ...
  _proto.removeIterable = function removeIterable(items, itemsSize) {
    if (itemsSize <= 0) {
      return false;
    }
  ...
  _proto._move = function _move(oldIndex, newIndex) {
    var _array = this._array;
  ...
  _proto.moveRange = function moveRange(start, end, moveIndex) {
    if (start === moveIndex) {
      return false;
    }
  ...
  _proto.indexOf = function indexOf(item, start, end, bound) {
    var _size = this._size,
        _array = this._array,
        _compare = this._compare,
        _autoSort = this._autoSort;
  ...
  _proto.contains = function contains(item) {
    var _context13;
  ...
  _proto.toArray = function toArray(start, end) {
    var _size = this._size,
        _array = this._array,
        _autoSort = this._autoSort;
  ...
  _proto.copyTo = function copyTo(destArray, destIndex, start, end) {
    var _size = this._size,
        _array = this._array;
...
function () {
  ...
  var _proto2 = MergeSortedListWrapper.prototype;
