...
function () {
  ...
  var _proto = DeepCloneEqual.prototype;

  _proto.isPrimitive = function isPrimitive(value) {
    var commonOptions = this.commonOptions;
    var isPrimitive = commonOptions && commonOptions.customIsPrimitive || isPrimitiveDefault;
    return isPrimitive(value);
  };

  _proto.clone = function clone(value, options, cache) {
  ...
  _proto.equal = function equal(obj1, obj2, options) {
