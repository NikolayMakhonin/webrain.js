...
class DeepCloneEqual {
  ...
  isPrimitive(value) {
    ...
    const isPrimitive = commonOptions && commonOptions.customIsPrimitive || isPrimitiveDefault;
    return isPrimitive(value);
  }

  clone(value, options, cache) {
    ...
    const clone = source => {
      ...
      switch (sourceTag) {
        ...
        case 'Map':
          for (const item of source) {
            cloned.set(clone(item[0]), clone(item[1]));
          }
  ...
  equal(obj1, obj2, options) {
    ...
    const equal = (o1, o2) => {
      ...
      if (options && (options.circular || options.equalInnerReferences)) {
        const id1 = (0, _objectUniqueId.getObjectUniqueId)(o1);
        const id2 = (0, _objectUniqueId.getObjectUniqueId)(o2);
      ...
      if (typeof o1[Symbol.iterator] === 'function') {
        if (typeof o2[Symbol.iterator] === 'function') {
          if (Array.isArray(o1) && Array.isArray(o2)) {
              ...
              if (tag1 === 'Set' || tag2 === 'Set' || isMap) {
                ...
                for (const item1 of o1) {
                  ...
                  for (const item2 of o2) {
                    ...
                    nodeId++;
                    const result = isMap ? equal(item1[0], item2[0]) && equal(item1[1], item2[1]) : equal(item1, item2);
            ...
            const iterator1 = o1[Symbol.iterator]();
            const iterator2 = o2[Symbol.iterator]();
