...
const deepCloneEqual = new _DeepCloneEqual.DeepCloneEqual({
  commonOptions: {
    ...
    customIsPrimitive: o => {
      ...
      if (o.constructor === Number || o.constructor === Boolean || o.constructor === String && Object.isFrozen(o) || !(0, _objectUniqueId.canHaveUniqueId)(o)) {
        return true;
      }
...
const assert = new _Assert.Assert(deepCloneEqual);
const NONE = Object.freeze(new String('NONE'));
exports.NONE = NONE;
const BASE = Object.freeze(new String('BASE'));
exports.BASE = BASE;
const OLDER = Object.freeze(new String('OLDER'));
exports.OLDER = OLDER;
const NEWER = Object.freeze(new String('NEWER'));
exports.NEWER = NEWER;

class TypeMetaMergerCollectionMock extends _mergers.TypeMetaMergerCollection {
  constructor() {
    super();
    this._resetFuncs = [];
  }
...
const merger = new _mergers.ObjectMerger(TypeMetaMergerCollectionMock.default);
...
class TestMerger extends _TestVariants.TestVariants {
  constructor() {
    super();
