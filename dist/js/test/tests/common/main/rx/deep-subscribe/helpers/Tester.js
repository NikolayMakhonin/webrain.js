...
function createObject() {
  ...
  function (_ObservableObject) {
    (0, _inheritsLoose2.default)(ObservableClass, _ObservableObject);
  ...
  (0, _assign.default)(object, (_Object$assign2 = {}, _Object$assign2[_valueProperty.VALUE_PROPERTY_DEFAULT] = 'nothing', _Object$assign2.observableObjectPrototype = observableObjectPrototype, _Object$assign2.observableObject = observableObject, _Object$assign2.observableList = observableList, _Object$assign2.observableSet = observableSet, _Object$assign2.observableMap = observableMap, _Object$assign2.object = object, _Object$assign2.property = property, _Object$assign2.list = list, _Object$assign2.set = set, _Object$assign2.map2 = map2, _Object$assign2.value = 'value', _Object$assign2.valueObject = new String('value'), _Object$assign2.promiseSync = {
...
function () {
  ...
  _proto.checkSubscribes = function checkSubscribes(subscribes, expectedSubscribes) {
  ...
  _proto.subscribePrivate = function subscribePrivate(ruleBuilder, i) {
    var _this = this;
  ...
  _proto.subscribe = function subscribe(expectedSubscribed, expectedUnsubscribed, errorType, errorRegExp) {
    var _this2 = this;
  ...
  _proto.change = function change(changeFunc, expectedUnsubscribed, expectedSubscribed, errorType, errorRegExp) {
    var _this3 = this;
  ...
  _proto.unsubscribe = function unsubscribe(expectedUnsubscribed, errorType, errorRegExp) {
    var _this4 = this;
