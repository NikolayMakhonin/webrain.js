...
/* eslint-disable */
var MapPolyfill = function (exports) {
  'use strict';
  ...
  var ie8DomDefine = !descriptors && !fails(function () {
    return (0, _defineProperty.default)(documentCreateElement('div'), 'a', {
      get: function get() {
        return 7;
      }
    }).a != 7;
  ...
  */
  ...
  var _export = function _export(options, source) {
    ...
    for (key in source) {
      ...
      if ((0, _bind.default)(options) && USE_NATIVE) resultProperty = bindContext(sourceProperty, global_1); // wrap global constructors for prevent changs in this version
  ...
  var nativeSymbol = !!_getOwnPropertySymbols.default && !fails(function () {
  ...
  var isArray = _isArray.default || function isArray(arg) {
  ...
  var forEach = (0, _forEach.default)(arrayIteration);
  ...
  var collection = function collection(CONSTRUCTOR_NAME, wrapper, common, IS_MAP, IS_WEAK) {
    ...
    if (!descriptors || typeof NativeConstructor != 'function' || !(IS_WEAK || (0, _forEach.default)(NativePrototype) && !fails(function () {
      ...
      (0, _entries.default)(_context2 = new NativeConstructor()).call(_context2).next();
    }))) {
  ...
  var indexOf = (0, _indexOf.default)(arrayIncludes);
  ...
  var objectKeys = _keys2.default || function keys(O) {
    return objectKeysInternal(O, enumBugKeys);
  }; // `Object.defineProperties` method
  // https://tc39.github.io/ecma262/#sec-object.defineproperties


  var objectDefineProperties = descriptors ? _defineProperties.default : function defineProperties(O, Properties) {
    anObject(O);
  ...
  var objectCreate = _create.default || function create(O, Properties) {
    var result;
  ...
  var objectGetPrototypeOf = correctPrototypeGetter ? _getPrototypeOf.default : function (O) {
    O = toObject(O);
  ...
  if ((0, _keys.default)([])) {
    ...
    arrayIterator = (0, _keys.default)(_context3 = []).call(_context3); // Safari 8 has buggy iterators w/o `next`
  ...
  var objectSetPrototypeOf = _setPrototypeOf.default || ('__proto__' in {} ? function () {
  ...
  }, collectionStrong, true); // `String.prototype.{ codePointAt, at }` methods implementation
  ...
  var map$1 = map;
  var map$2 = map$1;
  exports.MapPolyfill = map$2;
  return exports.MapPolyfill;
}({});
