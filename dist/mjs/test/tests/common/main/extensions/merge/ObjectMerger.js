...
describe('common > extensions > merge > ObjectMerger', function () {
  ...
  describe('collections', function () {
    ...
    describe('maps', function () {
      ...
      it('Map', function () {
        testMergeMaps([o => fillMap(new Map(), o), o => fillMap(new Map(), o)], [o => fillMap(new Map(), o), o => fillMap(new Map(), o)], [[0, null], [func, func], [void 0, {
          a: 1,
          b: 2
        }], [object, {
          a: 2,
    ...
    describe('sets', function () {
      ...
      it('Set', function () {
        testMergeSets([o => fillSet(new Set(), o), o => fillSet(new Set(), o)], [o => fillSet(new Set(), o), o => fillSet(new Set(), o)], [0, func, void 0], [0, func, object], [0, 1, void 0, object], [0, 1, object]);
      });
    });
  });
});