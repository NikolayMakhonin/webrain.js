...
describe('common > main > rx > observable-object-builder-prototype', function () {
  ...
  it('writable', function () {
    ...
    const baseBuilder1 = new ObservableObjectBuilder(BaseClass1.prototype).writable('baseProp1');
    const baseBuilder2 = new ObservableObjectBuilder(BaseClass2.prototype).writable('baseProp2');
    const builder1 = new ObservableObjectBuilder(Class1.prototype).writable('prop1');
    const builder2 = new ObservableObjectBuilder(Class2.prototype).writable('prop2');
  ...
  it('readable', function () {
    ...
    const baseBuilder1 = new ObservableObjectBuilder(BaseClass1.prototype).readable('baseProp1');
    const baseBuilder2 = new ObservableObjectBuilder(BaseClass2.prototype).readable('baseProp2');
    const builder1 = new ObservableObjectBuilder(Class1.prototype).readable('prop1');
    const builder2 = new ObservableObjectBuilder(Class2.prototype).readable('prop2');
    const baseObject1 = new BaseClass1();
    const baseObject2 = new BaseClass2();
    const object1 = new Class1();
    const object2 = new Class2(); // eslint-disable-next-line prefer-const
