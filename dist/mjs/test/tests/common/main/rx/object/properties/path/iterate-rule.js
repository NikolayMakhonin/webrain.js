...
import { iterateRule, subscribeNextRule } from '../../../../../../../../main/common/rx/object/properties/path/iterate-rule';
...
describe('common > main > rx > properties > builder > iterate-rule', function () {
  ...
  function rulesIteratorToObject(ruleIterator, obj = {}, prevIsFork) {
    ...
    return subscribeNextRule(ruleIterator, iteration, nextRuleIterator => rulesIteratorToObject(nextRuleIterator, obj, isFork), (rule, getRuleIterable) => {
      if (rule.type === RuleType.Never) {
        return null;
      }

      const newObj = {};
      const unsubscribe = rulesIteratorToObject(getRuleIterable ? getRuleIterable(testObject)[Symbol.iterator]() : null, newObj, isFork);
      mergeObjects(obj, {
  ...
  function forEachRuleToObject(rule, obj = {}, prevIsFork) {
    forEachRule(rule, obj, (value, parent, key, keyType) => {
      if (parent != null) {
  ...
  function testForEachRules(buildRule, ...expectedPaths) {
    const rule = buildRule(new RuleBuilder({
  ...
  function testIterateRule(buildRule, ...expectedPaths) {
    ...
    assert.ok(result);
    const object = {};
    const unsubscribe = rulesIteratorToObject(result[Symbol.iterator](), object); // console.log(JSON.stringify(object, null, 4))
  ...
  it('nothing', function () {
    testIterateRule(b => b.any(b => b.p('a'), b => b.nothing()).any(b => b.p('a'), b => b.nothing()).p('c'), 'a.a.c', 'a.c', 'c');
  ...
  it('any', function () {
    ...
    testIterateRule(b => b.any(b => b.p('a'), b => b.p('b')), 'a', 'b');
    testIterateRule(b => b.any(b => b.p('a').p('b'), b => b.p('c').p('d')), 'a.b', 'c.d');
    testIterateRule(b => b.any(b => b.any(b => b.p('a').p('b'), b => b.p('c').p('d')), b => b.p('e').p('f')), 'a.b', 'c.d', 'e.f');
    testIterateRule(b => b.any(b => b.p('a').p('b').any(b => b.p('c').p('d'), b => b.p('e').p('f'), b => b.any(b => b.never(), b => b.never())), b => b.p('g').p('h')).p('i'), 'a.b.c.d.i', 'a.b.e.f.i', 'g.h.i');
    testIterateRule(b => b.any(b => b.never(), b => b.p('a'), b => b.nothing(), b => b.p('b')), '', 'a', 'b');
  });
  xit('path any', function () {
    testIterateRule(b => b.p('a', 'b').p('c'), 'a|b.c');
    testIterateRule(b => b.propertyRegexp(/[ab]/).p('c'), '/[ab]/.c');
  });
  it('repeat', function () {
    testIterateRule(b => b.repeat(1, 1, null, b => b.p('a')), 'a');
    testIterateRule(b => b.repeat(2, 2, null, b => b.p('a')), 'a.a');
    testIterateRule(b => b.repeat(1, 2, null, b => b.p('a')), 'a', 'a.a');
    testIterateRule(b => b.repeat(0, 2, null, b => b.p('a')), '', 'a', 'a.a');
    testIterateRule(b => b.repeat(0, 2, null, b => b.repeat(0, 2, null, b => b.p('a')).p('b')), '', 'b', 'a.b', 'a.a.b', 'b.b', 'b.a.b', 'b.a.a.b', 'a.b.b', 'a.b.a.b', 'a.b.a.a.b', 'a.a.b.b', 'a.a.b.a.b', 'a.a.b.a.a.b');
    testIterateRule(b => b.repeat(1, 2, null, b => b.any(b => b.repeat(1, 2, null, b => b.p('a')), b => b.p('b').p('c'))).p('d'), 'a.d', 'a.a.d', 'b.c.d', // 'a.a.d',
    'a.a.a.d', 'a.b.c.d', // 'a.a.a.d',
    'a.a.a.a.d', 'a.a.b.c.d', 'b.c.a.d', 'b.c.a.a.d', 'b.c.b.c.d');
    testIterateRule(b => b.any(b => b.repeat(2, 2, null, b => b.any(b => b.p('a'), b => b.p('b'))), b => b.p('c')).p('d'), 'a.a.d', 'a.b.d', 'b.a.d', 'b.b.d', 'c.d');
  });
  it('throws', function () {
  ...
  it('specific', function () {
    testIterateRule(b => b.any(b => b.p('a'), b => b.repeat(0, 0, null, b => b.p('b')).p('c')), 'a', 'c');
  });
});