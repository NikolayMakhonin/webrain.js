...
describe('common > main > rx > properties > CalcObjectBuilder', function () {
  ...
  new CalcObjectBuilder(ClassSync.prototype).calc('prop1', connectorFactory(c => c.connect('connectValue1', b => b.path(o => o['@lastOrWait'].source['@wait']))), calcPropertyFactory((input, property) => {
    property.value = new Date(123);
    return ThenableSync.createResolved(null);
  }));
  new CalcObjectBuilder(ClassAsync.prototype).calc('prop1', connectorFactory(c => c.connect('connectValue1', b => b.path(o => o['@lastOrWait'].source['@wait']))), calcPropertyFactory(function* (input, property) {
