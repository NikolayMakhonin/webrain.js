...
describe('common > main > rx > deep-subscribe > deep-subscribe', function () {
  ...
  it('any', function () {
    ...
    new TestDeepSubscribe({
      ...
      immediate: true,
      doNotSubscribeNonObjectValues: true
    }, b => b.any(o => o.path(o => o['map2|set']), o => o.path(o => o['map2|set']), o => o.path(o => o['map2|set'].object.observableObject))).subscribe(o => [o.map2, o.set], null, o => [o.map2]).change(o => {
  ...
  it('value properties', async function () {
    ...
    new TestDeepSubscribe({
      ...
      immediate: true,
      doNotSubscribeNonObjectValues: true
    }, b => b.any(o => o.path(o => o.property['@value_observableObject']['map2|set']), o => o.path(o => o.property['@value_observableObject']['map2|set']), o => o.path(o => o.property['@value_observableObject']['map2|set'].object.observableObject)), b => b.any(o => o.path(o => o.property['map2|set']), o => o.path(o => o.property['map2|set']), o => o.path(o => o.property['map2|set'].object.observableObject))).subscribe(o => [o.map2, o.set], null, o => [o.map2]).change(o => {
      o.set = o.observableObject;
    }, o => [o.set], o => [o.observableObject], o => []).unsubscribe(o => [o.map2, o.set]);
  });
