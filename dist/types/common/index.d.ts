...
import { EnumOf as _EnumOf, EnumType as _EnumType } from './helpers/enum';
...
export declare type EnumOf<TEnumType> = _EnumOf<TEnumType>;
export declare type EnumType<TEnum extends string | number = string | number> = _EnumType<TEnum>;
