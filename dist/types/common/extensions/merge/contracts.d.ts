...
export declare type IValueMerge<TTarget = any, TSource = any> = (merge: IMergeValue, base: TTarget, older: TTarget | TSource, newer: TTarget | TSource, set?: (value: TTarget) => void, preferCloneBase?: boolean, preferCloneOlder?: boolean, preferCloneNewer?: boolean, options?: IMergeOptions) => boolean;
...
export interface IMergeable<TTarget, TSource = any> {
    ...
    _merge(merge: IMergeValue, older: TTarget | TSource, newer: TTarget | TSource, preferCloneBase?: boolean, preferCloneOlder?: boolean, preferCloneNewer?: boolean, options?: IMergeOptions): boolean;
}
