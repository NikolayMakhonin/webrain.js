...
export declare function throwOnConsoleError<TContext, TValue>(_this: TContext, throwPredicate: (this: TConsoleType, ...args: any[]) => boolean, func: (this: TContext) => TValue): ThenableIterator<AsyncValueOf<TValue>>;
