...
export interface IRuleBuilder<TObject = any, TValueKeys extends string | number = never> {
     ...
     * Custom func
     */
    func<TValue>(subscribe: ISubscribeObject<TObject, TValue>, subType: SubscribeObjectType, description?: string): IRuleBuilder<TValue, TValueKeys>;
    /**
     * Custom func
     */
    ...
    if<TValue>(...exclusiveConditionRules: Array<[
        (value: TValue) => boolean,
        IRuleFactory<TObject, TValue, TValueKeys>
    ] | IRuleFactory<TObject, TValue, TValueKeys>>): IRuleBuilder<TValue, TValueKeys>;
