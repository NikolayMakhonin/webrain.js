...
export declare class DependConnectorBuilder<TObject extends Connector<TSource> | ObservableClass, TSource = TObject, TValueKeys extends string | number = ValueKeys> extends ObservableObjectBuilder<TObject> {
    ...
    connectPath<Name extends string | number = Extract<keyof TObject, string | number>, TValue = Name extends keyof TObject ? TObject[Name] : TSource>(name: Name, common: TNextPath<TSource, TSource, TValue>, getSet?: null | undefined, options?: IConnectFieldOptions<TSource, TValue>): this & {
        object: {
            [newProp in Name]: TValue;
        };
    };
    connectPath<Name extends string | number = Extract<keyof TObject, string | number>, TCommonValue = TSource, TValue = Name extends keyof TObject ? TObject[Name] : TCommonValue>(name: Name, common: TNextPath<TSource, TSource, TCommonValue>, getSet: INextPathGetSet<TSource, TCommonValue, TValue>, options?: IConnectFieldOptions<TSource, TValue>): this & {
        object: {
            [newProp in Name]: TValue;
        };
    };
...
export declare function dependConnectorClass<TSource, TConnectorClass extends TBaseClass, TBaseClass extends Connector<TSource> = Connector<TSource>>(build: (connectorBuilder: DependConnectorBuilder<TBaseClass, TSource>) => {
    object: TConnectorClass;
}, baseClass?: TClass<[TSource, string?], TBaseClass>): TClass<[TSource, string?], TConnectorClass>;
export declare function dependConnectorFactory<TSource extends ObservableClass, TConnectorClass extends TBaseClass, TBaseClass extends Connector<TSource> = Connector<TSource>>({ name, build, baseClass, }: {
    name?: string;
    build: (connectorBuilder: DependConnectorBuilder<TBaseClass, TSource>) => {
        object: TConnectorClass;
    };
