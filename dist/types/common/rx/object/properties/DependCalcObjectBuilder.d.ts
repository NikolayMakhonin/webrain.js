...
export declare class DependCalcObjectBuilder<TObject extends ObservableClass, TConnectorSource = TObject, TCalcSource = TObject, TValueKeys extends string | number = ValueKeys> extends DependConnectorBuilder<TObject, TConnectorSource> {
    ...
    simpleCalc<Name extends keyof TObject>(name: Name, func: (this: TCalcSource) => ThenableOrIteratorOrValue<TObject[Name]>): this & {
        object: {
            readonly [newProp in Name]: TObject[Name];
        };
    };
    dependCalc<Name extends keyof TObject>(name: Name, func: (this: TCalcSource) => ThenableOrIteratorOrValue<TObject[Name]>, deferredOptions?: IDeferredOptions): this & {
        object: {
            readonly [newProp in Name]: TObject[Name];
        };
    };
    dependCalcX<Name extends keyof TObject>(name: Name, func: (this: CallState<TObject, any[], TObject[Name]>) => ThenableOrIteratorOrValue<TObject[Name]>, deferredOptions?: IDeferredOptions): this & {
        object: {
            readonly [newProp in Name]: TObject[Name];
        };
    };
    nested<Name extends keyof TObject, TPropertyClass extends PropertyClass<TObject>>(name: Name, build: (builder: DependCalcObjectBuilder<PropertyClass<TObject>, TObject>) => {
...
export declare function propertyClass<TObject, TPropertyClass extends TBaseClass, TBaseClass extends PropertyClass<TObject> = PropertyClass<TObject>>(build: (builder: DependCalcObjectBuilder<TBaseClass, TObject>) => {
    object: TPropertyClass;
...
export declare function dependCalcPropertyFactory<TInput, TValue>({ name, calcFunc, deferredOptions, }: {
    name?: string;
...
export declare function dependCalcPropertyFactoryX<TInput, TValue>({ name, calcFunc, deferredOptions, }: {
    name?: string;
