...
export declare function connectorFactory<TSource extends ObservableObject, TConnector extends ObservableObject>(build: (connectorBuilder: ConnectorBuilder<ObservableObject, TSource>) => {
    object: TConnector;
