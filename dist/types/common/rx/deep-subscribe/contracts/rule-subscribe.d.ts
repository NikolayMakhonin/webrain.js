...
export declare type ISubscribeObject<TObject, TChild> = (object: TObject, immediateSubscribe: boolean, subscribeItem: (item: TChild, debugPropertyName: string) => void, unsubscribeItem: (item: TChild, debugPropertyName: string) => void) => IUnsubscribeOrVoid;
