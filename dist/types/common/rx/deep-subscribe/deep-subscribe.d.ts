...
export declare function deepSubscribeRule<TValue>({ object, changeValue, lastValue, immediate, rule, }: {
    object: any;
...
export declare function deepSubscribe<TObject, TValue, TValueKeys extends string | number = never>({ object, changeValue, lastValue, immediate, ruleBuilder, }: {
    object: TObject;
    changeValue?: IChangeValue<TValue>;
    lastValue?: ILastValue<TValue>;
    /** @deprecated Not implemented - always true */
