...
;function createCommonjsModule(fn,module){
	...
	var _core=createCommonjsModule(function(module){
		...
		}),document=_global.document,is=_isObject(document)&&_isObject(document.createElement),_domCreate=function(it){
	...
	;var ceil=Math.ceil,floor=Math.floor,_toInteger=function(it){
			...
			}(fn),void 0===that)return fn;switch(length){
				case 1:return function(a){return fn.call(that,a)}
					;case 2:return function(a,b){
					return fn.call(that,a,b)};case 3:
	...
	;var IS_INCLUDES,_export=$export,_iterators={},_iobject=Object("z").propertyIsEnumerable(0)?Object:function(it){
			...
			;return O
		},document$1=_global.document,_html=document$1&&document$1.documentElement,IE_PROTO$1=_sharedKey("IE_PROTO"),Empty=function(){},_createDict=function(){
	...
	;for(var ITERATOR$1=_wks("iterator"),TO_STRING_TAG=_wks("toStringTag"),ArrayValues=_iterators.Array,DOMIterables={
		...
		;throw void 0!==ret&&_anObject(ret.call(iterator)),
			e}
	},ITERATOR$2=_wks("iterator"),ArrayProto$1=Array.prototype,ITERATOR$3=_wks("iterator"),core_getIteratorMethod=_core.getIteratorMethod=function(it){
		...
		var BREAK={},RETURN={},exports=module.exports=function(iterable,entries,fn,that,ITERATOR){
			var length,step,iterator,result,it,iterFn=ITERATOR?function(){
					return iterable
	...
	}),SPECIES=_wks("species"),_meta=createCommonjsModule(function(module){
	...
	},ITERATOR$4=_wks("iterator"),SAFE_CLOSING=!1;try{
		[7][ITERATOR$4]().return=function(){
			SAFE_CLOSING=!0}}catch(e){}var _objectPie={
		...
		;if("function"==typeof C&&(IS_WEAK||proto.forEach&&!_fails(function(){
			...
			var instance=new C,HASNT_CHAINING=instance[ADDER](IS_WEAK?{}:-0,1)!=instance,THROWS_ON_PRIMITIVES=_fails(function(){
					...
					if(!skipClosing&&!SAFE_CLOSING)return!1
						...
						},exec(arr)}catch(e){}return safe}(function(iter){
					new C(iter)
	...
	})("SetPolyfill",function(get){return function(){
