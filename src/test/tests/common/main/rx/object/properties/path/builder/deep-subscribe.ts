...
// import {getChangeId} from '../../../../../../../../../main/common/rx/object/properties/path/builder/rules-subscribe'
...
//
// describe('common > main > rx > properties > builder > deep-subscribe', function() {
...
// 		const changeIds = ids => ids.map(o => o + changeId) as number[]
//
// 		new TestDeepSubscribe(
// 			{
// 				object: createObject().observableObject,
...
// 				.change(),
// 		)
// 			.subscribe(o => changeIds([1]))
// 			.unsubscribe(o => changeIds([1]))
// 			.subscribe(o => changeIds([2]))
// 			.unsubscribe(o => changeIds([2]))
// 			.subscribe(o => changeIds([3]))
// 			.change(o => o.observableObject.value = 1, changeIds([3]), changeIds([4]))
// 			.unsubscribe(o => changeIds([4]))
//
...
// 			.unsubscribe(o => changeIds([2]))
// 			.subscribe(o => changeIds([3]))
// 			.change(o => o.observableList.add(o), changeIds([3, 4]), changeIds([4, 5]))
// 			.unsubscribe(o => changeIds([5]))
//
// 		changeId = getChangeId()
// 		new TestDeepSubscribe(
// 			{
...
// 			.unsubscribe(o => changeIds([2]))
// 			.subscribe(o => changeIds([3]))
// 			.change(o => o.observableSet.delete(o), changeIds([3, 4]), changeIds([4, 5]))
// 			.unsubscribe(o => changeIds([5]))
//
// 		changeId = getChangeId()
// 		new TestDeepSubscribe(
...
// 			.unsubscribe(o => changeIds([2]))
// 			.subscribe(o => changeIds([3]))
// 			.change(o => o.observableMap.delete('property'), changeIds([3, 4]), changeIds([4, 5]))
// 			.unsubscribe(o => changeIds([5]))
// 	})
//
...
// 				),
// 		)
// 			.subscribe(o => ['value'], null, o => ['value'])
// 			.unsubscribe(o => ['value'])
//
// 		new TestDeepSubscribe(
// 			{
...
// 				.p('prop'),
// 		)
// 			.change(o => { o.value = null }, o => [], o => [], o => [])
// 			.subscribe(o => [], null, o => [])
// 			.change(o => { o.value = { prop: 'prop' } }, o => [], o => ['prop'], o => ['prop'])
// 			.change(o => { o.value = 123 }, o => ['prop'], o => [], o => [void 0])
// 			.change(o => { o.value = null }, o => [], o => [], o => [])
// 			.unsubscribe(o => [])
//
// 		new TestDeepSubscribe(
...
// 			.subscribe(o => [], null, o => [])
// 			.change(o => { o.value = { prop: 'prop' } }, o => [], o => ['prop'], o => ['prop'])
// 			.change(o => { o.value = null }, o => ['prop'], o => [], o => [void 0])
// 			.change(o => { o.observableObject.observableList.insert(0, { value: { prop: 'prop' } } as any) }, o => [], o => ['prop'], o => ['prop'])
// 			.change(o => { o.observableObject.observableList.set(0, 123 as any) }, o => ['prop'], o => [], o => [void 0])
// 			.unsubscribe(o => [])
//
// 		new TestDeepSubscribe(
// 			{
